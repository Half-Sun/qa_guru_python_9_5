...
browser.config.base_url = "http://app.qa.guru"
...
def test_fill_form():
    ...
    browser.element('[type="submit"]').perform(command.js.scroll_into_view).click()
    ...
    browser.all('[class="MuiTypography-root MuiTypography-body1 css-1qye57c"]')[0].should(have.exact_text('Olga'))
